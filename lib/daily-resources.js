...
export const LISTENING_RESOURCES = {
  // A1 Level - Very Basic (Slow, Clear French)
  A1: [
    {
      title: "Coffee Break French - Lesson 1",
      url: "https://coffeebreaklanguages.com/coffeebreakfrench/",
      description: "Perfect for absolute beginners. Slow, clear explanations with English support.",
      duration: "15-20 min",
      type: "podcast"
    },
    {
      title: "FrenchPod101 - Absolute Beginner",
      url: "https://www.frenchpod101.com/",
      description: "Structured beginner lessons with vocabulary and grammar.",
      duration: "10-15 min",
      type: "podcast"
    },
    {
      title: "Learn French with Alexa - Beginner",
      url: "https://www.youtube.com/c/LearnFrenchWithAlexa",
      description: "YouTube lessons with clear pronunciation and subtitles.",
      duration: "10-20 min",
      type: "youtube"
    },
    {
      title: "Français avec Pierre - Débutant",
      url: "https://www.youtube.com/c/FrancaisavecPierre",
      description: "Beginner French with French subtitles available.",
      duration: "10-15 min",
      type: "youtube"
    },
    {
      title: "Easy French - Super Beginner",
      url: "https://www.youtube.com/c/EasyFrench",
      description: "Street interviews with French and English subtitles.",
      duration: "5-10 min",
      type: "youtube"
    }
  ],
  
  // A2 Level - Elementary (Slightly faster, more natural)
  A2: [
    {
      title: "News in Slow French",
      url: "https://www.newsinslowfrench.com/",
      description: "Current events spoken slowly and clearly. Perfect for building comprehension.",
      duration: "20-30 min",
      type: "podcast"
    },
    {
      title: "Duolingo French Podcast",
      url: "https://podcast.duolingo.com/french",
      description: "True stories in easy-to-follow French with English narration.",
      duration: "20-25 min",
      type: "podcast"
    },
    {
      title: "InnerFrench - Beginner Episodes",
      url: "https://innerfrench.com/podcast/",
      description: "Hugo speaks clearly about interesting topics. Episodes 1-30 are A2 level.",
      duration: "20-30 min",
      type: "podcast"
    },
    {
      title: "French Voices Podcast",
      url: "https://www.frenchvoices.co.uk/",
      description: "Interviews with French speakers, clear speech with transcripts.",
      duration: "15-25 min",
      type: "podcast"
    },
    {
      title: "Piece of French",
      url: "https://www.pieceoffrench.com/podcast/",
      description: "Cultural topics explained in clear, slow French.",
      duration: "15-20 min",
      type: "podcast"
    }
  ],
  
  // B1 Level - Intermediate (Natural speed, complex topics)
  B1: [
    {
      ...
      description: "Daily 10-minute news in simplified French. Essential for TEF prep.",
      duration: "10 min",
      type: "podcast"
    },
    {
      ...
      description: "Natural French about various topics. Great for authentic speech patterns.",
      duration: "15-25 min",
      type: "podcast"
    },
    {
      ...
      description: "Daily life in France described in natural French with transcripts.",
      duration: "3-5 min",
      type: "podcast"
    },
    {
      title: "InnerFrench - Intermediate Episodes",
      url: "https://innerfrench.com/podcast/",
      description: "Episodes 30+ cover more complex topics at natural speed.",
      duration: "25-40 min",
      type: "podcast"
    },
    {
      ...
      description: "French culture and society discussions at intermediate level.",
      duration: "20-30 min",
      type: "podcast"
    }
  ],
  
  // B2 Level - Upper Intermediate (Native speed, complex content)
  B2: [
    {
      title: "France Inter - Le 7/9",
      url: "https://www.radiofrance.fr/franceinter/podcasts/le-7-9",
      description: "Morning news show. Real French at native speed.",
      duration: "Variable",
      type: "radio"
    },
    {
      title: "France Culture - Les Pieds sur terre",
      url: "https://www.radiofrance.fr/franceculture/podcasts/les-pieds-sur-terre",
      description: "Documentary-style stories about real life in France.",
      duration: "28 min",
      type: "podcast"
    },
    {
      title: "Transfert - Slate.fr",
      url: "https://www.slate.fr/transfert",
      description: "True stories told by ordinary people. Native French.",
      duration: "20-40 min",
      type: "podcast"
    },
    {
      ...
      description: "High-quality French audio documentaries and stories.",
      duration: "Variable",
      type: "podcast"
    },
    {
      title: "France Info - Le vrai du faux",
      url: "https://www.francetvinfo.fr/replay-radio/le-vrai-du-faux/",
...
export const READING_RESOURCES = {
  A1: [
    {
      title: "Lingua.com - French Reading A1",
      url: "https://lingua.com/french/reading/",
      description: "Short texts with comprehension questions. Start here.",
      type: "website"
    },
    {
      title: "French Today - Beginner Blog Posts",
      url: "https://www.frenchtoday.com/blog/",
      description: "Simple articles about French culture and language.",
      type: "blog"
    },
    {
      title: "LingQ - Mini Stories",
      url: "https://www.lingq.com/en/learn-french-online/",
      description: "Simple stories with audio and translation support.",
      type: "app"
    },
    {
      title: "TV5Monde - Apprendre A1",
      url: "https://apprendre.tv5monde.com/fr/niveaux/a1-debutant",
      description: "Free A1 exercises with videos and texts.",
      type: "website"
    }
  ],
  ...
  A2: [
    {
      ...
      url: "https://www.ebooksgratuits.com/html/st_exupery_le_petit_prince.html",
      description: "Classic French book. Simple vocabulary, beautiful story.",
      type: "book"
    },
    {
      title: "TV5Monde - Apprendre A2",
      url: "https://apprendre.tv5monde.com/fr/niveaux/a2-elementaire",
      description: "A2 level exercises with authentic French media.",
      type: "website"
    },
    {
      title: "Le Monde des ados",
      url: "https://www.lemondedesados.fr/",
      description: "News magazine for teens. Simpler vocabulary than adult news.",
      type: "magazine"
    },
    {
      title: "1jour1actu",
      url: "https://www.1jour1actu.com/",
      description: "News explained for children. Clear, simple French.",
      type: "website"
    }
  ],
  ...
  B1: [
    {
      title: "Journal en français facile - Transcripts",
      url: "https://savoirs.rfi.fr/fr/apprendre-enseigner/langue-francaise/journal-en-francais-facile",
      description: "Read along with the audio. Great for TEF reading prep.",
      type: "website"
    },
    {
      title: "20 Minutes",
      url: "https://www.20minutes.fr/",
      description: "Free French newspaper. Short, accessible articles.",
      type: "newspaper"
    },
    {
      title: "Le Monde - Articles simples",
      url: "https://www.lemonde.fr/",
      description: "Start with lifestyle and culture sections.",
      type: "newspaper"
    },
    {
      title: "French short stories - Project Gutenberg",
      url: "https://www.gutenberg.org/ebooks/search/?query=french&submit_search=Go%21",
      description: "Free classic French literature.",
      type: "ebooks"
    }
  ],
  ...
  B2: [
    {
      title: "Le Monde",
      url: "https://www.lemonde.fr/",
      description: "France's newspaper of record. Complex analysis and opinion.",
      type: "newspaper"
    },
    {
      title: "Le Figaro",
      url: "https://www.lefigaro.fr/",
      description: "Major French newspaper. Diverse topics and viewpoints.",
      type: "newspaper"
    },
    {
      title: "Courrier International",
      url: "https://www.courrierinternational.com/",
      description: "International news translated into French. Varied styles.",
      type: "magazine"
    },
    {
      title: "L'Obs",
      url: "https://www.nouvelobs.com/",
      description: "In-depth articles on French society and politics.",
      type: "magazine"
    }
  ]
};
...
// ============ HELPER FUNCTION TO GET DAILY RESOURCES ============
...
function getResourceForDay(resources, dayNumber, pathway) {
  ...
  const index = (dayNumber - 1) % levelResources.length;
  return {
    ...levelResources[index],
    level
  };
}
